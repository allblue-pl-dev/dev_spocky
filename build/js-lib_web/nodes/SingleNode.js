jsLibs.exportModule('spocky', 'nodes/SingleNode', (require, module) => { 'use strict';
...
class SingleNode extends Node
{
    ...
    { let self = this;
        ...
        HtmlElement.AddChild(self.parentNode.htmlElement, self._htmlElement,
                self.nextHtmlElement);
    }

    __onNodeDeactivate()
    { let self = this;
        HtmlElement.RemoveChild(self.parentNode.htmlElement, self._htmlElement);
    }
